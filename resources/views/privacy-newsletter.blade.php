        ...
        <div id="sections" class="row g-0 justify-content-center h-100 mt-5">
            <div class="content col-md-12 overflow-hidden">
                <div class="row g-3 justify-content-center">
                    <div class="col-md-10">
                        {{-- Paragraph --}}
                        <x-sections.title :title="tolgee('privacies.privacy-newsletter.title')" :subtitle="tolgee('privacies.privacy-newsletter.subtitle', ['website' => request()->host()])" />
                    </div>
                </div>
                ...
                <div class="row g-0 gy-5 justify-content-center mb-5">
                    <div class="col-lg-8 p-4 px-md-5 text-start">
                        @tolgee('privacies.privacy-newsletter.privacy', [
                            ...
                            "privacy_link" => RouteController::route("privacy")
                        ])
                    </div>
                </div>
